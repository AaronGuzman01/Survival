...
public class MovementJoystick : MonoBehaviour
{
    ...
    void Start()
    {
        joystickOriginalPos = joystickB.transform.position;
        joystickRadius = joystickB.GetComponent<RectTransform>().sizeDelta.y / 4;
    }
    ...
    public void PointerDown()
    {
        ...
        joystickB.transform.position = Input.mousePosition;
